...
function _switch_font(_opt){
	...
	var  txtdiv = document.createElement("div");txtdiv.id="leikpyar_converter";txtdiv.className='converter';txtdiv.innerHTML = '<span style="cursor:pointer;" onclick="_deactivate(\'leikpyar_converter\');">[X]&nbsp;<\/span><span>Change Font &nbsp;<\/span><span><select  onchange="_switch_font(this.value);"><option value=1'+(_curFont==1?' selected':'')+'>Zawgyi-One<\/option><option value=2'+(_curFont==2?' selected':'')+'>Unicode<\/option><\/select><\/span>';
